import{h as L,G as U,S as F,V as y,a as j,R as W,P as V,W as K,M as k,b as $,D as I,A as Y,c as J,O as X,C as Q,d as Z,e as ee,f as E}from"./vendor.518a8179.js";const te=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerpolicy&&(o.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?o.credentials="include":s.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}};te();var p;(function(c){c[c.STOLEN_NECKLACE=0]="STOLEN_NECKLACE",c[c.SEGMENTS=1]="SEGMENTS",c[c.SHADER_LAMP=2]="SHADER_LAMP",c[c.SPACE_COLOR=3]="SPACE_COLOR",c[c.SINUSOID=4]="SINUSOID",c[c.ASSERT_POSITION_BOUNDARY=5]="ASSERT_POSITION_BOUNDARY"})(p||(p={}));var b;(function(c){c[c.ABSOLUTE=0]="ABSOLUTE",c[c.DELTA=1]="DELTA"})(b||(b={}));var r;(function(c){c.CREATE_SPHERE="create-sphere",c.SET_NECKLACE_CONFIGURATION_BY_NUMBER="necklace-configuration-by-number",c.SET_NECKLACE_CONFIGURATION_BY_STRING="necklace-configuration-by-string",c.UPDATE_SPHERE_MATERIAL="update-material",c.NECKLACE_CUT="necklace-cut",c.UPDATE_VISIBLE="update-visible",c.THEME_CHANGED="theme-changed",c.MODEL_CHANGED="model-changed",c.SHOW_IMPRINT="show-imprint",c.HIDE_IMPRINT="hide-imprint"})(r||(r={}));const ne="modulepreload",R={},ie="/necklace-splitting/",se=function(e,t){return!t||t.length===0?e():Promise.all(t.map(i=>{if(i=`${ie}${i}`,i in R)return;R[i]=!0;const s=i.endsWith(".css"),o=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${o}`))return;const a=document.createElement("link");if(a.rel=s?"stylesheet":ne,s||(a.as="script",a.crossOrigin=""),a.href=i,document.head.appendChild(a),s)return new Promise((d,h)=>{a.addEventListener("load",d),a.addEventListener("error",h)})})).then(()=>e())},oe=async()=>await se(()=>import("./imprint-gen.e21e9e5f.js"),[]),ae='<hr><p style="opacity: 1.0;">Dieses Impressum wurde erstellt durch <a href="https://www.impressum-generator.de" rel="nofollow">impressum-generator.de</a>.</p>',re=`<hr><div class="center" width=100%>
<button id="hide-imprint" onclick="document.body.dispatchEvent(new Event('${r.HIDE_IMPRINT.toString()}', { bubbles: true }))">Close</button></div>`;class ce{constructor(){window.addEventListener("resize",()=>{this._div!==void 0&&(this.hide(),this.show())}),document.body.addEventListener(r.SHOW_IMPRINT.toString(),()=>{this.show()}),document.body.addEventListener(r.HIDE_IMPRINT.toString(),()=>{this.hide()}),document.body.addEventListener("keydown",e=>{(e.key==="Esc"||e.key==="Escape")&&this.hide()})}async isAvailable(){const e=await oe();return this._decryptedAES=e.decryptedAES,this._decryptedAES()!==void 0}show(){this._div=document.createElement("div"),this._div.classList.add("imprint"),this._div.classList.add("padding"),this._div.innerHTML=this._decryptedAES();const e=this._div;document.body.appendChild(e);const t=window.getComputedStyle(document.body),i=e.scrollWidth-10,s=e.scrollHeight,o=t.getPropertyValue("background-color");L(e,{backgroundColor:o,windowWidth:i,windowHeight:s}).then(a=>{e.classList.remove("padding"),e.innerHTML="",e.appendChild(a);const d=document.createElement("p");d.classList.add("padding"),d.innerHTML=ae+re,e.appendChild(d)})}hide(){this._div!==void 0&&(document.body.removeChild(this._div),this._div=void 0)}}const w=.001,le=w*w,_e=32,C=["Stolen Necklace","Segments only","Shader Lamp","Space Colors","Sinusoid","Test Position Ranges"],n={showcase:C[p.STOLEN_NECKLACE],int_mode:p.STOLEN_NECKLACE,necklace:{number_of_jewels:24,configuration:13579652,string:"",show_solution_band:!0,show_solutions:!0,absolute_distribution:!0,epsilon:.01,discrete:!0},sphere:{radius:15,segments:128,radius_factor:1,offset_octant:0,use_bad_on_sphere_check:!1},animation:{rotation_x:0,rotation_y:0,rotation_z:0,reset_speed:he,trigger_reset:!1,run:!1},view:{dark_theme:!0,stats_monitor_visible:!1,necklace_visible:!0,gauge_visible:!0,show_single_thiefs_region:!0,assert_boundary:!0,axes_visible:!0,mesh_visible:!1,faces_visible:!0},color:{scale_red:1,scale_green:1,scale_blue:1,alpha:1},capture:{},imprint:de,radio:C[p.STOLEN_NECKLACE],text:void 0};class _{static addRadioButtonsFolder(e,t,i,s,o=(a,d,h)=>{}){const a=e.addFolder(t);return _.addRadioButtons(a,i,s,o)}static addRadioButtons(e,t,i,s=(o,a,d)=>{}){const o=t;return t={},i.forEach((a,d)=>{const h=`option_${d}`;t[h]=o===a}),i.forEach((a,d)=>{const h=`option_${d}`;e.add(t,h).name(a).listen().onChange(()=>{for(let u in t)t[u]=h===u;s(t,h,d)})}),e}constructor(){this.gui=new U,this.gui.domElement.id="gui";const e=_.addRadioButtonsFolder(this.gui,`Showcase: ${n.radio}`,n.radio,C,(l,T,g)=>{n.int_mode=g,_.dispatchEvent(r.CREATE_SPHERE),e.name=`Showcase: ${C[g]}`,e.close()}),t=this.gui.addFolder("Necklace");t.add(n.necklace,"number_of_jewels",0,_e,1).name("Jewels").onChange(()=>{const l=2**n.necklace.number_of_jewels-1;n.necklace.configuration=Math.min(l,n.necklace.configuration),i.min(0).max(l).setValue(n.necklace.configuration),_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)});const i=t.add(n.necklace,"configuration",0,2**n.necklace.number_of_jewels-1,1).name("Configuration").onChange(()=>_.dispatchEvent(r.SET_NECKLACE_CONFIGURATION_BY_NUMBER));t.add(n.necklace,"string").name("String").onChange(()=>_.dispatchEvent(r.SET_NECKLACE_CONFIGURATION_BY_STRING)),t.add(n.necklace,"discrete").name("Discrete").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),t.add(n.necklace,"show_solution_band").name("Solution Band").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),console.error("Enable feature"),t.add(n.necklace,"absolute_distribution").name("Absolute/Relative").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE)),t.add(n.necklace,"epsilon",0,.15).name("epsilon").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL));const s=this.gui.addFolder("View");s.add(n.view,"dark_theme").name("Dark theme").onChange(()=>_.dispatchEvent(r.THEME_CHANGED)),s.add(n.view,"show_single_thiefs_region").name("Single thief's area").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),s.add(n.view,"axes_visible").name("Axes").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE)),s.add(n.view,"mesh_visible").name("Mesh").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE)),s.add(n.view,"faces_visible").name("Faces").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE));const o=s.addFolder("Sphere");o.add(n.sphere,"radius",1,50,1).name("Radius").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE)),o.add(n.sphere,"offset_octant",0,5,.1).name("Octant Offset").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE)),o.add(n.sphere,"use_bad_on_sphere_check").name("Bad Check").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),o.add(n.sphere,"segments",3,511,1).name("Segments").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE)),o.add(n.sphere,"radius_factor",.01,1.5,.01).name("Scaling").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE));const a=s.addFolder("Other Controls");a.add(n.view,"stats_monitor_visible").name("Monitor").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE)),a.add(n.view,"necklace_visible").name("Necklace").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE)),a.add(n.view,"gauge_visible").name("Gauge").onChange(()=>_.dispatchEvent(r.UPDATE_VISIBLE)),a.add(n.view,"assert_boundary").name("Assert ranges").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE));const d=s.addFolder("Color");d.add(n.color,"scale_red",0,1).name("Red").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),d.add(n.color,"scale_green",0,1).name("Green").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),d.add(n.color,"scale_blue",0,1).name("Blue").onChange(()=>_.dispatchEvent(r.UPDATE_SPHERE_MATERIAL)),d.add(n.color,"alpha",0,1).name("Alpha").onChange(()=>_.dispatchEvent(r.CREATE_SPHERE));const h=s.addFolder("Animation");h.add(n.animation,"run").name("Animate").listen(),h.add(n.animation,"rotation_x",-1,1,.1).name("Rot-X").listen(),h.add(n.animation,"rotation_y",-1,1,.1).name("Rot-Y").listen(),h.add(n.animation,"rotation_z",-1,1,.1).name("Rot-Z").listen(),h.add(n.animation,"reset_speed").name("Reset Rot"),this._captureFolder=this.gui.addFolder("Screen capture"),new ce().isAvailable().then(l=>{l&&this.gui.add(n,"imprint").name("Imprint")})}static dispatchEvent(e){const t=new Event(e.toString(),{bubbles:!0});document.body.dispatchEvent(t)}get captureFolder(){return this._captureFolder}}function he(){n.animation.trigger_reset=!0,n.animation.run=!1,n.animation.rotation_x=0,n.animation.rotation_y=0,n.animation.rotation_z=0}function de(){_.dispatchEvent(r.SHOW_IMPRINT)}HTMLCanvasElement.prototype.getContext=function(c){return function(e,t){return t=t||{},t.preserveDrawingBuffer=!0,c.call(this,e,t)}}(HTMLCanvasElement.prototype.getContext);const O=["All","Sphere","Necklace"];class ue{constructor(e,t={all:HTMLElement=void 0,sphere:HTMLElement=void 0,necklace:HTMLElement=void 0}){this._fBeforeCapture=()=>document.body,this._configureSettings(e,t),document.addEventListener("keydown",i=>{i.ctrlKey&&i.key==="#"&&this.capture()})}_configureSettings(e,t){this._optionsArray=[t.all,t.sphere,t.necklace];const i=e.folder,s=e.property;s.selection=O[0],this._captionIndex=0,this._fBeforeCapture=()=>this._optionsArray[this._captionIndex],s.on_capture_clicked=()=>this.capture(),_.addRadioButtons(i,s.selection,O,(o,a,d)=>{this._captionIndex=d}),i.add(s,"on_capture_clicked").name("Click or press 's'")}capture(e=this._fBeforeCapture){console.log(`screenCapture ${e}`);const t=e();if(!t)throw new Error("No element to capture");setTimeout(()=>{const s=window.getComputedStyle(document.body).getPropertyValue("background-color");L(t,{backgroundColor:s}).then(o=>{const a=document.createElement("a");a.href=o.toDataURL(),a.download="necklace.png",a.click()})},100)}}class fe{constructor(e,t=void 0,i=void 0){this.setSize(e,t,i),window.addEventListener("resize",()=>{this.setSize(e,t,i),this.onResize()})}setSize(e,t,i){const s=Math.min(innerWidth,e.clientWidth),o=Math.min(innerHeight,e.clientHeight);t!==void 0&&(t.aspect=s/o,t.updateProjectionMatrix()),i!==void 0&&(i.setSize(s,o),i.setPixelRatio(window.devicePixelRatio))}onResize(){}}var pe=`uniform int u_mode;
