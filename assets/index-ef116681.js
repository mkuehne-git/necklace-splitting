...
</svg>`,Oo=.001,D0=Oo*Oo,H0=32,Hs=["Stolen Necklace","Shader Lamp","Space Colors","Sinusoid"],Ae={showcase:Hs[xt.STOLEN_NECKLACE],int_mode:xt.STOLEN_NECKLACE,necklace:{number_of_jewels:24,configuration:13579652,string:"",show_solution_band:!0,show_solutions:!0,epsilon:.01,discrete:!0},sphere:{radius:15,segments:128,offset_octant:0,use_bad_on_sphere_check:!1,show_borsuk_ulam_proof_shape:!1},animation:{rotation_x:0,rotation_y:0,rotation_z:0,reset_speed:P0,trigger_reset:!1,run:!1},view:{stats_monitor_visible:!1,necklace_visible:!0,gauge_visible:!0,show_single_thiefs_region:!0,axes_visible:!0,mesh_visible:!1,faces_visible:!0},color:{scale_red:1,scale_green:1,scale_blue:1,alpha:1},capture:{},imprint:()=>se.dispatchEvent(se.SHOW_IMPRINT),radio:Hs[xt.STOLEN_NECKLACE],text:void 0};var wr,Mn,Ci,fA,Gt,Fn;const zs=class zs{constructor(){Xe(this,wr,void 0);Xe(this,Mn,void 0);Xe(this,Ci,void 0);Xe(this,fA,void 0);Xe(this,Gt,void 0);Xe(this,Fn,void 0);He(this,fA,new Jo),V(this,fA).domElement.id="gui",this.createSettingsIcon(),this.createShowHideListener(),this.createShowcaseFolder(),this.createNecklaceFolder(),this.createViewFolder(),this.createCaptureFolder()}static addRadioButtonsFolder(e,A,t,i,r=(s,a,o)=>{}){const s=e.addFolder(A);return zs.addRadioButtons(s,t,i,r),s}static addRadioButtons(e,A,t,i=(r,s,a)=>{}){const r=A;A={},t.forEach((s,a)=>{const o=`option_${a}`;A[o]=r===s}),t.forEach((s,a)=>{const o=`option_${a}`;e.add(A,o).name(s).listen().onChange(()=>{for(let l in A)A[l]=o===l;i(A,o,a)})})}createSettingsIcon(){var A,t;const e=document.createElement("DIV");e.innerHTML=I0+R0,He(this,Gt,e.querySelector("#settings-icon")),He(this,Fn,e.querySelector("#settings-close-icon")),V(this,Gt).classList.add("show"),V(this,fA).hide(),V(this,fA).domElement.insertAdjacentElement("beforeBegin",V(this,Gt)),V(this,Gt).insertAdjacentElement("afterEnd",V(this,Fn)),new $u(V(this,fA).domElement,(i,r)=>{const s=i.target;r===0&&!(s!=null&&s.classList.contains("transition"))&&(s!=null&&s.classList.contains("closed"))&&(V(this,fA).hide(),V(this,fA).close(),this.toggleSettings())}),(A=V(this,Gt))==null||A.addEventListener("click",()=>{this.toggleSettings(),V(this,fA).show(),V(this,fA).open()}),(t=V(this,Fn))==null||t.addEventListener("click",()=>{V(this,fA).$title.click()})}toggleSettings(){V(this,Gt).classList.toggle("show"),V(this,Fn).classList.toggle("show")}createShowHideListener(){window.addEventListener("keydown",e=>{(e.key==="h"||e.key==="H")&&(V(this,Ci)?V(this,fA).show():V(this,fA).hide(),He(this,Ci,!V(this,Ci)))})}createShowcaseFolder(){He(this,Mn,zs.addRadioButtonsFolder(V(this,fA),`Showcase: ${Ae.radio}`,Ae.radio,Hs,(e,A,t)=>{Ae.int_mode=t,se.dispatchEvent(se.CREATE_SPHERE),V(this,Mn).title(`Showcase: ${Hs[t]}`),V(this,Mn).close()})),V(this,Mn).close()}createNecklaceFolder(){const e=V(this,fA).addFolder("Necklace");e.add(Ae.necklace,"number_of_jewels",0,H0,1).name("Jewels").onChange(()=>{const t=2**Ae.necklace.number_of_jewels-1;Ae.necklace.configuration=Math.min(t,Ae.necklace.configuration),A.min(0).max(t).setValue(Ae.necklace.configuration),se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)});const A=e.add(Ae.necklace,"configuration",0,2**Ae.necklace.number_of_jewels-1,1).name("Configuration").onChange(()=>se.dispatchEvent(se.SET_NECKLACE_CONFIGURATION_BY_NUMBER));e.add(Ae.necklace,"string").name("String").onChange(()=>se.dispatchEvent(se.SET_NECKLACE_CONFIGURATION_BY_STRING)),e.add(Ae.necklace,"discrete").name("Discrete").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),e.add(Ae.necklace,"show_solution_band").name("Solution Band").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),e.add(Ae.necklace,"show_solutions").name("Solutions").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),e.add(Ae.necklace,"epsilon",0,.15).name("epsilon").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),e.close()}createViewFolder(){const e=V(this,fA).addFolder("View");e.add(Ae.view,"show_single_thiefs_region").name("Single Thief's Area").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),e.add(Ae.view,"axes_visible").name("Axes").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),e.add(Ae.view,"mesh_visible").name("Mesh").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),e.add(Ae.view,"faces_visible").name("Faces").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),e.close(),this.createSphereSubFolder(e),this.createControlsSubFolder(e),this.createColorSubFolder(e),this.createAnimationSubFolder(e)}createSphereSubFolder(e){const A=e.addFolder("Sphere");A.add(Ae.sphere,"radius",1,50,1).name("Radius").onChange(()=>se.dispatchEvent(se.CREATE_SPHERE)),A.add(Ae.sphere,"offset_octant",0,5,.1).name("Octant Offset").onChange(()=>se.dispatchEvent(se.CREATE_SPHERE)),A.add(Ae.sphere,"use_bad_on_sphere_check").name("Bad Check").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),A.add(Ae.sphere,"show_borsuk_ulam_proof_shape").name("Borsuk-Ulam Proof").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),A.add(Ae.sphere,"segments",3,511,1).name("Segments").onChange(()=>se.dispatchEvent(se.CREATE_SPHERE)),A.close()}createControlsSubFolder(e){const A=e.addFolder("Other Controls");A.add(Ae.view,"stats_monitor_visible").name("Monitor").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),A.add(Ae.view,"necklace_visible").name("Necklace").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),A.add(Ae.view,"gauge_visible").name("Gauge").onChange(()=>se.dispatchEvent(se.UPDATE_VISIBLE)),A.close()}createColorSubFolder(e){const A=e.addFolder("Color");A.add(Ae.color,"scale_red",0,1).name("Red").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),A.add(Ae.color,"scale_green",0,1).name("Green").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),A.add(Ae.color,"scale_blue",0,1).name("Blue").onChange(()=>se.dispatchEvent(se.UPDATE_SPHERE_MATERIAL)),A.add(Ae.color,"alpha",0,1).name("Alpha").onChange(()=>se.dispatchEvent(se.CREATE_SPHERE)),A.close()}createAnimationSubFolder(e){const A=e.addFolder("Animation"),t=.5;A.add(Ae.animation,"run").name("Rotate [Hz]").listen(),A.add(Ae.animation,"rotation_x",-t,t,.1).name("X").listen(),A.add(Ae.animation,"rotation_y",-t,t,.1).name("Y").listen(),A.add(Ae.animation,"rotation_z",-t,t,.1).name("Z").listen(),A.add(Ae.animation,"reset_speed").name("Reset Rotation"),A.close()}createCaptureFolder(){const e=V(this,fA).addFolder("Screen capture");new L0().isAvailable().then(i=>{i&&V(this,fA).add(Ae,"imprint").name("Imprint")}),e.close(),He(this,wr,e)}get captureFolder(){return V(this,wr)}};wr=new WeakMap,Mn=new WeakMap,Ci=new WeakMap,fA=new WeakMap,Gt=new WeakMap,Fn=new WeakMap;let Ps=zs;function P0(){Ae.animation.trigger_reset=!0,Ae.animation.run=!1,Ae.animation.rotation_x=0,Ae.animation.rotation_y=0,Ae.animation.rotation_z=0}const O0=`<svg xmlns="http://www.w3.org/2000/svg" id="light-icon" class="themes-icon" viewBox="0 0 24 24" width="512" height="512">
