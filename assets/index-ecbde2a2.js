...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qt,depthTest:!1,depthWrite:!1})}function $c(){return new tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:qt,depthTest:!1,depthWrite:!1})}function eu(){return new tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:qt,depthTest:!1,depthWrite:!1})}function Ho(){return`
	...
	`}function VE(n){let e=new WeakMap,A=null;function t(a){if(a&&a.isTexture){const o=a.mapping,l=o===uo||o===ho,c=o===ii||o===ri;if(l||c)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=e.get(a);return A===null&&(A=new Zc(n)),u=l?A.fromEquirectangular(a,u):A.fromCubemap(a,u),e.set(a,u),u.texture}else{if(e.has(a))return e.get(a).texture;{const u=a.image;if(l&&u&&u.height>0||c&&u&&i(u)){A===null&&(A=new Zc(n));const h=l?A.fromEquirectangular(a):A.fromCubemap(a);return e.set(a,h),a.addEventListener("dispose",r),h.texture}else return null}}}return a}function i(a){let o=0;const l=6;for(let c=0;c<l;c++)a[c]!==void 0&&o++;return o===l}function r(a){const o=a.target;o.removeEventListener("dispose",r);const l=e.get(o);l!==void 0&&(e.delete(o),l.dispose())}function s(){e=new WeakMap,A!==null&&(A.dispose(),A=null)}return{get:t,dispose:s}}function KE(n){const e={};function A(t){if(e[t]!==void 0)return e[t];let i;switch(t){case"WEBGL_depth_texture":i=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=n.getExtension(t)}return e[t]=i,i}return{has:function(t){return A(t)!==null},init:function(t){t.isWebGL2?A("EXT_color_buffer_float"):(A("WEBGL_depth_texture"),A("OES_texture_float"),A("OES_texture_half_float"),A("OES_texture_half_float_linear"),A("OES_standard_derivatives"),A("OES_element_index_uint"),A("OES_vertex_array_object"),A("ANGLE_instanced_arrays")),A("OES_texture_float_linear"),A("EXT_color_buffer_half_float"),A("WEBGL_multisampled_render_to_texture")},get:function(t){const i=A(t);return i===null&&console.warn("THREE.WebGLRenderer: "+t+" extension not supported."),i}}}function kE(n,e,A,t){const i={},r=new WeakMap;function s(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const m=h.morphAttributes[g];for(let d=0,f=m.length;d<f;d++)e.remove(m[d])}h.removeEventListener("dispose",s),delete i[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),t.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,A.memory.geometries--}function a(u,h){return i[h.id]===!0||(h.addEventListener("dispose",s),i[h.id]=!0,A.memory.geometries++),h}function o(u){const h=u.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const m=p[g];for(let d=0,f=m.length;d<f;d++)e.update(m[d],n.ARRAY_BUFFER)}}function l(u){const h=[],p=u.index,g=u.attributes.position;let m=0;if(p!==null){const v=p.array;m=p.version;for(let B=0,y=v.length;B<y;B+=3){const C=v[B+0],x=v[B+1],S=v[B+2];h.push(C,x,x,S,S,C)}}else if(g!==void 0){const v=g.array;m=g.version;for(let B=0,y=v.length/3-1;B<y;B+=3){const C=B+0,x=B+1,S=B+2;h.push(C,x,x,S,S,C)}}else return;const d=new(Kh(h)?Jh:Yh)(h,1);d.version=m;const f=r.get(u);f&&e.remove(f),r.set(u,d)}function c(u){const h=r.get(u);if(h){const p=u.index;p!==null&&h.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:o,getWireframeAttribute:c}}function zE(n,e,A,t){const i=t.isWebGL2;let r;function s(h){r=h}let a,o;function l(h){a=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(r,p,a,h*o),A.update(p,r,1)}function u(h,p,g){if(g===0)return;let m,d;if(i)m=n,d="drawElementsInstanced";else if(m=e.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[d](r,p,a,h*o,g),A.update(p,r,g)}this.setMode=s,this.setIndex=l,this.render=c,this.renderInstances=u}function WE(n){const e={geometries:0,textures:0},A={frame:0,calls:0,triangles:0,points:0,lines:0};function t(r,s,a){switch(A.calls++,s){case n.TRIANGLES:A.triangles+=a*(r/3);break;case n.LINES:A.lines+=a*(r/2);break;case n.LINE_STRIP:A.lines+=a*(r-1);break;case n.LINE_LOOP:A.lines+=a*r;break;case n.POINTS:A.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){A.calls=0,A.triangles=0,A.points=0,A.lines=0}return{memory:e,render:A,programs:null,autoReset:!0,reset:i,update:t}}function XE(n,e){return n[0]-e[0]}function YE(n,e){return Math.abs(e[1])-Math.abs(n[1])}function JE(n,e,A){const t={},i=new Float32Array(8),r=new WeakMap,s=new xA,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function o(l,c,u){const h=l.morphTargetInfluences;if(e.isWebGL2===!0){const p=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,g=p!==void 0?p.length:0;let m=r.get(c);if(m===void 0||m.count!==g){let T=function(){Z.dispose(),r.delete(c),c.removeEventListener("dispose",T)};m!==void 0&&m.texture.dispose();const v=c.morphAttributes.position!==void 0,B=c.morphAttributes.normal!==void 0,y=c.morphAttributes.color!==void 0,C=c.morphAttributes.position||[],x=c.morphAttributes.normal||[],S=c.morphAttributes.color||[];let R=0;v===!0&&(R=1),B===!0&&(R=2),y===!0&&(R=3);let _=c.attributes.position.count*R,M=1;_>e.maxTextureSize&&(M=Math.ceil(_/e.maxTextureSize),_=e.maxTextureSize);const G=new Float32Array(_*M*4*g),Z=new Wh(G,_,M,g);Z.type=Xt,Z.needsUpdate=!0;const Y=R*4;for(let O=0;O<g;O++){const X=C[O],K=x[O],j=S[O],W=_*M*4*O;for(let q=0;q<X.count;q++){const Q=q*Y;v===!0&&(s.fromBufferAttribute(X,q),G[W+Q+0]=s.x,G[W+Q+1]=s.y,G[W+Q+2]=s.z,G[W+Q+3]=0),B===!0&&(s.fromBufferAttribute(K,q),G[W+Q+4]=s.x,G[W+Q+5]=s.y,G[W+Q+6]=s.z,G[W+Q+7]=0),y===!0&&(s.fromBufferAttribute(j,q),G[W+Q+8]=s.x,G[W+Q+9]=s.y,G[W+Q+10]=s.z,G[W+Q+11]=j.itemSize===4?s.w:1)}}m={count:g,texture:Z,size:new ye(_,M)},r.set(c,m),c.addEventListener("dispose",T)}let d=0;for(let v=0;v<h.length;v++)d+=h[v];const f=c.morphTargetsRelative?1:1-d;u.getUniforms().setValue(n,"morphTargetBaseInfluence",f),u.getUniforms().setValue(n,"morphTargetInfluences",h),u.getUniforms().setValue(n,"morphTargetsTexture",m.texture,A),u.getUniforms().setValue(n,"morphTargetsTextureSize",m.size)}else{const p=h===void 0?0:h.length;let g=t[c.id];if(g===void 0||g.length!==p){g=[];for(let B=0;B<p;B++)g[B]=[B,0];t[c.id]=g}for(let B=0;B<p;B++){const y=g[B];y[0]=B,y[1]=h[B]}g.sort(YE);for(let B=0;B<8;B++)B<p&&g[B][1]?(a[B][0]=g[B][0],a[B][1]=g[B][1]):(a[B][0]=Number.MAX_SAFE_INTEGER,a[B][1]=0);a.sort(XE);const m=c.morphAttributes.position,d=c.morphAttributes.normal;let f=0;for(let B=0;B<8;B++){const y=a[B],C=y[0],x=y[1];C!==Number.MAX_SAFE_INTEGER&&x?(m&&c.getAttribute("morphTarget"+B)!==m[C]&&c.setAttribute("morphTarget"+B,m[C]),d&&c.getAttribute("morphNormal"+B)!==d[C]&&c.setAttribute("morphNormal"+B,d[C]),i[B]=x,f+=x):(m&&c.hasAttribute("morphTarget"+B)===!0&&c.deleteAttribute("morphTarget"+B),d&&c.hasAttribute("morphNormal"+B)===!0&&c.deleteAttribute("morphNormal"+B),i[B]=0)}const v=c.morphTargetsRelative?1:1-f;u.getUniforms().setValue(n,"morphTargetBaseInfluence",v),u.getUniforms().setValue(n,"morphTargetInfluences",i)}}return{update:o}}function qE(n,e,A,t){let i=new WeakMap;function r(o){const l=t.render.frame,c=o.geometry,u=e.get(o,c);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),o.isInstancedMesh&&(o.hasEventListener("dispose",a)===!1&&o.addEventListener("dispose",a),i.get(o)!==l&&(A.update(o.instanceMatrix,n.ARRAY_BUFFER),o.instanceColor!==null&&A.update(o.instanceColor,n.ARRAY_BUFFER),i.set(o,l))),o.isSkinnedMesh){const h=o.skeleton;i.get(h)!==l&&(h.update(),i.set(h,l))}return u}function s(){i=new WeakMap}function a(o){const l=o.target;l.removeEventListener("dispose",a),A.remove(l.instanceMatrix),l.instanceColor!==null&&A.remove(l.instanceColor)}return{update:r,dispose:s}}const Af=new WA,tf=new Wh,nf=new R_,rf=new jh,Au=[],tu=[],nu=new Float32Array(16),iu=new Float32Array(9),ru=new Float32Array(4);function ci(n,e,A){const t=n[0];if(t<=0||t>0)return n;const i=e*A;let r=Au[i];if(r===void 0&&(r=new Float32Array(i),Au[i]=r),e!==0){t.toArray(r,0);for(let s=1,a=0;s!==e;++s)a+=A,n[s].toArray(r,a)}return r}function dA(n,e){if(n.length!==e.length)return!1;for(let A=0,t=n.length;A<t;A++)if(n[A]!==e[A])return!1;return!0}function pA(n,e){for(let A=0,t=e.length;A<t;A++)n[A]=e[A]}function Ts(n,e){let A=tu[e];A===void 0&&(A=new Int32Array(e),tu[e]=A);for(let t=0;t!==e;++t)A[t]=n.allocateTextureUnit();return A}function ZE(n,e){const A=this.cache;A[0]!==e&&(n.uniform1f(this.addr,e),A[0]=e)}function jE(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(dA(A,e))return;n.uniform2fv(this.addr,e),pA(A,e)}}function $E(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else if(e.r!==void 0)(A[0]!==e.r||A[1]!==e.g||A[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),A[0]=e.r,A[1]=e.g,A[2]=e.b);else{if(dA(A,e))return;n.uniform3fv(this.addr,e),pA(A,e)}}function eC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(dA(A,e))return;n.uniform4fv(this.addr,e),pA(A,e)}}function AC(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(dA(A,e))return;n.uniformMatrix2fv(this.addr,!1,e),pA(A,e)}else{if(dA(A,t))return;ru.set(t),n.uniformMatrix2fv(this.addr,!1,ru),pA(A,t)}}function tC(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(dA(A,e))return;n.uniformMatrix3fv(this.addr,!1,e),pA(A,e)}else{if(dA(A,t))return;iu.set(t),n.uniformMatrix3fv(this.addr,!1,iu),pA(A,t)}}function nC(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(dA(A,e))return;n.uniformMatrix4fv(this.addr,!1,e),pA(A,e)}else{if(dA(A,t))return;nu.set(t),n.uniformMatrix4fv(this.addr,!1,nu),pA(A,t)}}function iC(n,e){const A=this.cache;A[0]!==e&&(n.uniform1i(this.addr,e),A[0]=e)}function rC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(dA(A,e))return;n.uniform2iv(this.addr,e),pA(A,e)}}function sC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else{if(dA(A,e))return;n.uniform3iv(this.addr,e),pA(A,e)}}function aC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(dA(A,e))return;n.uniform4iv(this.addr,e),pA(A,e)}}function oC(n,e){const A=this.cache;A[0]!==e&&(n.uniform1ui(this.addr,e),A[0]=e)}function lC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(dA(A,e))return;n.uniform2uiv(this.addr,e),pA(A,e)}}function cC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else{if(dA(A,e))return;n.uniform3uiv(this.addr,e),pA(A,e)}}function uC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(dA(A,e))return;n.uniform4uiv(this.addr,e),pA(A,e)}}function hC(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture2D(e||Af,i)}function fC(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture3D(e||nf,i)}function dC(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTextureCube(e||rf,i)}function pC(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture2DArray(e||tf,i)}function gC(n){switch(n){case 5126:return ZE;case 35664:return jE;case 35665:return $E;case 35666:return eC;case 35674:return AC;case 35675:return tC;case 35676:return nC;case 5124:case 35670:return iC;case 35667:case 35671:return rC;case 35668:case 35672:return sC;case 35669:case 35673:return aC;case 5125:return oC;case 36294:return lC;case 36295:return cC;case 36296:return uC;case 35678:case 36198:case 36298:case 36306:case 35682:return hC;case 35679:case 36299:case 36307:return fC;case 35680:case 36300:case 36308:case 36293:return dC;case 36289:case 36303:case 36311:case 36292:return pC}}function mC(n,e){n.uniform1fv(this.addr,e)}function BC(n,e){const A=ci(e,this.size,2);n.uniform2fv(this.addr,A)}function _C(n,e){const A=ci(e,this.size,3);n.uniform3fv(this.addr,A)}function wC(n,e){const A=ci(e,this.size,4);n.uniform4fv(this.addr,A)}function vC(n,e){const A=ci(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,A)}function EC(n,e){const A=ci(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,A)}function CC(n,e){const A=ci(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,A)}function xC(n,e){n.uniform1iv(this.addr,e)}function UC(n,e){n.uniform2iv(this.addr,e)}function yC(n,e){n.uniform3iv(this.addr,e)}function SC(n,e){n.uniform4iv(this.addr,e)}function MC(n,e){n.uniform1uiv(this.addr,e)}function FC(n,e){n.uniform2uiv(this.addr,e)}function bC(n,e){n.uniform3uiv(this.addr,e)}function TC(n,e){n.uniform4uiv(this.addr,e)}function QC(n,e,A){const t=this.cache,i=e.length,r=Ts(A,i);dA(t,r)||(n.uniform1iv(this.addr,r),pA(t,r));for(let s=0;s!==i;++s)A.setTexture2D(e[s]||Af,r[s])}function IC(n,e,A){const t=this.cache,i=e.length,r=Ts(A,i);dA(t,r)||(n.uniform1iv(this.addr,r),pA(t,r));for(let s=0;s!==i;++s)A.setTexture3D(e[s]||nf,r[s])}function LC(n,e,A){const t=this.cache,i=e.length,r=Ts(A,i);dA(t,r)||(n.uniform1iv(this.addr,r),pA(t,r));for(let s=0;s!==i;++s)A.setTextureCube(e[s]||rf,r[s])}function RC(n,e,A){const t=this.cache,i=e.length,r=Ts(A,i);dA(t,r)||(n.uniform1iv(this.addr,r),pA(t,r));for(let s=0;s!==i;++s)A.setTexture2DArray(e[s]||tf,r[s])}function DC(n){switch(n){case 5126:return mC;case 35664:return BC;case 35665:return _C;case 35666:return wC;case 35674:return vC;case 35675:return EC;case 35676:return CC;case 5124:case 35670:return xC;case 35667:case 35671:return UC;case 35668:case 35672:return yC;case 35669:case 35673:return SC;case 5125:return MC;case 36294:return FC;case 36295:return bC;case 36296:return TC;case 35678:case 36198:case 36298:case 36306:case 35682:return QC;case 35679:case 36299:case 36307:return IC;case 35680:case 36300:case 36308:case 36293:return LC;case 36289:case 36303:case 36311:case 36292:return RC}}class HC{constructor(e,A,t){this.id=e,this.addr=t,this.cache=[],this.setValue=gC(A.type)}}class PC{constructor(e,A,t){this.id=e,this.addr=t,this.cache=[],this.size=A.size,this.setValue=DC(A.type)}}class OC{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,A,t){const i=this.seq;for(let r=0,s=i.length;r!==s;++r){const a=i[r];a.setValue(e,A[a.id],t)}}}const Ia=/(\w+)(\])?(\[|\.)?/g;function su(n,e){n.seq.push(e),n.map[e.id]=e}function NC(n,e,A){const t=n.name,i=t.length;for(Ia.lastIndex=0;;){const r=Ia.exec(t),s=Ia.lastIndex;let a=r[1];const o=r[2]==="]",l=r[3];if(o&&(a=a|0),l===void 0||l==="["&&s+2===i){su(A,l===void 0?new HC(a,n,e):new PC(a,n,e));break}else{let u=A.map[a];u===void 0&&(u=new OC(a),su(A,u)),A=u}}}class qr{constructor(e,A){this.seq=[],this.map={};const t=e.getProgramParameter(A,e.ACTIVE_UNIFORMS);for(let i=0;i<t;++i){const r=e.getActiveUniform(A,i),s=e.getUniformLocation(A,r.name);NC(r,s,this)}}setValue(e,A,t,i){const r=this.map[A];r!==void 0&&r.setValue(e,t,i)}setOptional(e,A,t){const i=A[t];i!==void 0&&this.setValue(e,t,i)}static upload(e,A,t,i){for(let r=0,s=A.length;r!==s;++r){const a=A[r],o=t[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,i)}}static seqWithValue(e,A){const t=[];for(let i=0,r=e.length;i!==r;++i){const s=e[i];s.id in A&&t.push(s)}return t}}function au(n,e,A){const t=n.createShader(e);return n.shaderSource(t,A),n.compileShader(t),t}const GC=37297;let VC=0;function KC(n,e){const A=n.split(`
`),t=[],i=Math.max(e-6,0),r=Math.min(e+6,A.length);for(let s=i;s<r;s++){const a=s+1;t.push(`${a===e?">":" "} ${a}: ${A[s]}`)}return t.join(`
`)}function kC(n){const e=qe.getPrimaries(qe.workingColorSpace),A=qe.getPrimaries(n);let t;switch(e===A?t="":e===us&&A===cs?t="LinearDisplayP3ToLinearSRGB":e===cs&&A===us&&(t="LinearSRGBToLinearDisplayP3"),n){case It:case Ss:return[t,"LinearTransferOETF"];case EA:case Qo:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[t,"LinearTransferOETF"]}}function ou(n,e,A){const t=n.getShaderParameter(e,n.COMPILE_STATUS),i=n.getShaderInfoLog(e).trim();if(t&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const s=parseInt(r[1]);return A.toUpperCase()+`

`+i+`

`+KC(n.getShaderSource(e),s)}else return i}function zC(n,e){const A=kC(e);return`vec4 ${n}( vec4 value ) { return ${A[0]}( ${A[1]}( value ) ); }`}function WC(n,e){let A;switch(e){case V0:A="Linear";break;case K0:A="Reinhard";break;case k0:A="OptimizedCineon";break;case z0:A="ACESFilmic";break;case W0:A="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),A="Linear"}return"vec3 "+n+"( vec3 color ) { return "+A+"ToneMapping( color ); }"}function XC(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Si).join(`
`)}function YC(n){const e=[];for(const A in n){const t=n[A];t!==!1&&e.push("#define "+A+" "+t)}return e.join(`
`)}function JC(n,e){const A={},t=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let i=0;i<t;i++){const r=n.getActiveAttrib(e,i),s=r.name;let a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),A[s]={type:r.type,location:n.getAttribLocation(e,s),locationSize:a}}return A}function Si(n){return n!==""}function lu(n,e){const A=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,A).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function cu(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const qC=/^[ \t]*#include +<([\w\d./]+)>/gm;function Bo(n){return n.replace(qC,jC)}const ZC=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function jC(n,e){let A=Ne[e];if(A===void 0){const t=ZC.get(e);if(t!==void 0)A=Ne[t],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,t);else throw new Error("Can not resolve #include <"+e+">")}return Bo(A)}const $C=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function uu(n){return n.replace($C,ex)}function ex(n,e,A,t){let i="";for(let r=parseInt(e);r<parseInt(A);r++)i+=t.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function hu(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Ax(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Ih?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===g0?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Ft&&(e="SHADOWMAP_TYPE_VSM"),e}function tx(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ii:case ri:e="ENVMAP_TYPE_CUBE";break;case ys:e="ENVMAP_TYPE_CUBE_UV";break}return e}function nx(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case ri:e="ENVMAP_MODE_REFRACTION";break}return e}function ix(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Lh:e="ENVMAP_BLENDING_MULTIPLY";break;case N0:e="ENVMAP_BLENDING_MIX";break;case G0:e="ENVMAP_BLENDING_ADD";break}return e}function rx(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const A=Math.log2(e)-2,t=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,A),7*16)),texelHeight:t,maxMip:A}}function sx(n,e,A,t){const i=n.getContext(),r=A.defines;let s=A.vertexShader,a=A.fragmentShader;const o=Ax(A),l=tx(A),c=nx(A),u=ix(A),h=rx(A),p=A.isWebGL2?"":XC(A),g=YC(r),m=i.createProgram();let d,f,v=A.glslVersion?"#version "+A.glslVersion+`
...
}`,zx=`#define M_PI 3.1415926535897932384626433832795
uniform int u_mode;
uniform bool u_necklace_absolute;
uniform bool u_necklace_discrete;
uniform bool u_show_solution_band;
...
void main() {
    ...
    return;
}`;const Ha={x:0,y:0};class Wx extends of{#A;#e;#t;#n;#r;#i;#c;#a;#s;#o;#u;#l;constructor(e,A={id:"sphere",container:document.body}){super(e,A),this.canvas=this.domElement}initializeCanvas(){this.#A=new I(-1,20,-30),this.#e=new Rx,this.#t=new Px,this.#n=new jA(75,this.container.clientWidth/this.container.clientHeight,.1,1e3),this.#r=new sf({antialias:!0});const e=this.#r.domElement;return this.container.appendChild(e),this.#u=new Vx(this.container,this.#n,this.#r),this.#i=new pt(this.createSphereGeometry(),this.createSphereMaterial()),this.#i.visible=Ae.view.faces_visible,this.#a=new pt(this.createSphereGeometry(),new Ro({wireframe:!0,side:at,transparent:!0})),this.#a.visible=Ae.view.mesh_visible,this.#o=new Ox(20),this.#o.visible=Ae.view.axes_visible,this.#s=new Mi,this.#s.add(this.#i,this.#a,this.#o),this.#e.add(this.#s),this.#c=new Gx(this.#n,this.#r.domElement),this.#n.position.z=50,this.#c.update(),this.container.addEventListener(le.CREATE_SPHERE.toString(),()=>this.createSphere()),this.container.addEventListener("mousemove",A=>{Ha.x=A.clientX/this.container.clientWidth*2-1,Ha.y=-(A.clientY/this.container.clientHeight)*2+1}),this.container.addEventListener(le.UPDATE_SPHERE_MATERIAL.toString(),()=>this.updateSphereMaterial()),this.container.addEventListener(le.UPDATE_VISIBLE.toString(),()=>this.updateVisibility()),this.container.addEventListener(le.THEME_CHANGED.toString(),()=>this.updateVisibility()),e}onMutation(e){const t=window.getComputedStyle(this.container).getPropertyValue("background-color");this.#e.background=new Ye(t)}get captureElement(){return this.#r.domElement}render(){const e=A=>{this.#l===void 0&&(this.#l=A),this._render(A-this.#l),this.#l=A,requestAnimationFrame(e)};e((performance||Date).now())}_render(e){if($t.begin(),this.#c.update(),this.#r.render(this.#e,this.#n),this.#i.visible||this.#a.visible){this.#t.setFromCamera(Ha,this.#n);const A=this.#t.intersectObject(this.#i),t=this.#i.material.uniforms;if(A.length>0&&!Ae.animation.run){const i=A[0].point.clone();t.u_intersect.value=i,this._setIntersect(i)}else t.u_intersect.value=new I,this.domElement.style.cursor="auto"}if(Ae.animation.trigger_reset)Ae.animation.trigger_reset=!1,this.#s.rotation.x=0,this.#s.rotation.y=0,this.#s.rotation.z=0;else if(Ae.animation.run){const A=Math.PI*e/500;this.#s.rotation.x+=Ae.animation.rotation_x*A,this.#s.rotation.y+=Ae.animation.rotation_y*A,this.#s.rotation.z+=Ae.animation.rotation_z*A}$t.end()}_setIntersect(e){if(e.distanceToSquared(this.#A)>c0){this.domElement.style.cursor="none",this.#A=e;const A=Ae.sphere.radius||1;this.model.applyCut(e.clone().divideScalar(A))}}createSphere(){this.#i.geometry.dispose(),this.#a.geometry.dispose();const e=this.createSphereGeometry();this.#i.geometry=e,this.#a.geometry=e,this.updateSphereMaterial()}createSphereGeometry(){const e=Ae.sphere.segments;return new Po(Ae.sphere.radius,e,e/2)}createSphereMaterial(){return new tn({vertexShader:kx,fragmentShader:zx,side:at,transparent:!0,defines:this.defines,uniforms:this.uniforms})}get defines(){return{MAX_JEWELS:Math.max(1,this.model.necklace.length),MODE_STOLEN_NECKLACE:dt.STOLEN_NECKLACE,MODE_SHADER_LAMP:dt.SHADER_LAMP,MODE_SPACE_COLOR:dt.SPACE_COLOR,MODE_SINUSOID:dt.SINUSOID}}get uniforms(){return Ae.sphere.offset_octant/Ae.sphere.radius,{u_mode:{type:"i",value:Ae.int_mode},u_necklace_discrete:{type:"b",value:Ae.necklace.discrete},u_input:{type:"i",value:this.model.necklace},u_count_0:{type:"i",value:this.model.count_0},u_count_1:{type:"i",value:this.model.count_1},u_offset_sphere_octant:{type:"f",value:Ae.sphere.offset_octant},u_use_bad_on_sphere_check:{type:"b",value:Ae.sphere.use_bad_on_sphere_check},u_show_borsuk_ulam_proof_shape:{type:"b",value:Ae.sphere.show_borsuk_ulam_proof_shape},u_radius_vector:{type:"v3",value:new I(Ae.sphere.radius,Ae.sphere.radius,Ae.sphere.radius)},u_scale_color:{type:"v3",value:new I(Ae.color.scale_red,Ae.color.scale_green,Ae.color.scale_blue)},u_epsilon:{type:"f",value:Ae.necklace.epsilon},u_show_solution_band:{type:"b",value:Ae.necklace.show_solution_band},u_show_solutions:{type:"b",value:Ae.necklace.show_solutions},u_show_single_thiefs_region:{type:"b",value:Ae.view.show_single_thiefs_region},u_alpha:{type:"f",value:Ae.color.alpha},u_time:{type:"f",value:1},u_resolution:{type:"v2",value:new ye(this.#r.domElement.width,this.#r.domElement.height)},u_intersect:{type:"v3",value:new I(0,0,0)}}}updateSphereMaterial(){this.#i!==void 0&&this.#i.material.dispose(),this.#i.material=this.createSphereMaterial(),this.#a.material.transparent=Ae.color.alpha!=1,le.dispatchEvent(le.MODEL_CHANGED)}updateVisibility(){this.#o.visible=Ae.view.axes_visible,this.#a.visible=Ae.view.mesh_visible,this.#i.visible=Ae.view.faces_visible,$t.visible(Ae.view.stats_monitor_visible),le.dispatchEvent(le.MODEL_CHANGED)}}const Xx="--jewel-a-color",Yx="--jewel-b-color",cf="--thief-a-color",uf="--thief-b-color",Jx=`${cf}-light`,qx=`${uf}-light`,Zx="--between-jewels-color",jx="--gauge-color",$x="red",eU="green",AU="rgb(0,191,255)",Yn=10,yu=20,tU=5,nU=7;class iU extends of{constructor(e,A={id:"necklace",container:document.body}){super(e,A),this.canvas=this.domElement,window.addEventListener("resize",()=>{const t=Math.min(innerWidth,this.container.clientWidth),i=Math.min(innerHeight,this.container.clientHeight);this.canvas.width=t,this.canvas.height=i,this.render()})}onMutation(e){this.render()}initializeCanvas(){const e=document.createElement("canvas");return e.setAttribute("id","necklace"),e.classList.add("necklace"),this.container.addEventListener(le.NECKLACE_CUT.toString(),()=>this.render()),this.container.addEventListener(le.MODEL_CHANGED.toString(),()=>this.render()),e}get size(){return this.model.size}get width(){return this.canvas.width}get height(){return this.canvas.height}get jewelWidth(){return this.width/this.size}get thief_a_color(){return getComputedStyle(document.body).getPropertyValue(cf)}get thief_b_color(){return getComputedStyle(document.body).getPropertyValue(uf)}get thief_a_color_light(){return getComputedStyle(document.body).getPropertyValue(Jx)}get thief_b_color_light(){return getComputedStyle(document.body).getPropertyValue(qx)}get between_jewels_color(){return getComputedStyle(document.body).getPropertyValue(Zx)}get jewel_a_color(){return getComputedStyle(document.body).getPropertyValue(Xx)}get jewel_b_color(){return getComputedStyle(document.body).getPropertyValue(Yx)}get gauge_color(){return getComputedStyle(document.body).getPropertyValue(jx)}get captureElement(){return this.domElement}get showNecklace(){return Ae.int_mode===dt.STOLEN_NECKLACE&&Ae.view.necklace_visible}get showGauge(){return Ae.int_mode===dt.STOLEN_NECKLACE&&Ae.view.gauge_visible}render(){this.canvas!==void 0&&this._render()}_render(){this.canvas.width=this.canvas.clientWidth,this.canvas.height=this.canvas.clientHeight;const e=this.canvas.getContext("2d");if(e!==null){const A=e,t=0,i=0;let r=t;const s=this.model.cuts;if(this.showNecklace&&(this.drawNecklace(A,r,i,s),s!==void 0&&this.drawSegments(A,s)),this.model.thief_a!==void 0&&this.showGauge){const a=this.model.canonicalThief(this.model.thief_a),o=this.model.canonicalThief(this.model.thief_b);this.drawGauge(A,50,a,o)}Ae.text&&(A.font="12px",A.fillStyle="rgb(255,255,255)",A.fillText(Ae.text,0,150))}}drawNecklace(e,A,t,i){const s=Yn+yu;i===void 0&&(e.fillStyle=this.between_jewels_color,e.fillRect(A,t,this.width,Yn));const a=this.jewel_a_color,o=this.jewel_b_color;let l=A;for(let c=0;c<this.size;c++){const u=this.model.necklace[Math.floor(c)];e.fillStyle=u===0?a:o,e.fillRect(l,t+this.yOffset(i,c/this.size,s),this.jewelWidth-2,Yn),l+=this.jewelWidth}}drawSegments(e,A){let t=0;e.save(),e.lineWidth=this.showNecklace?1:Yn,e.strokeStyle=$x,t=this.drawSegment(e,t,A.x),e.strokeStyle=eU,t=this.drawSegment(e,t,A.y),e.strokeStyle=AU,t=this.drawSegment(e,t,A.z),e.restore()}drawSegment(e,A,t){e.beginPath();const i=this.yOffsetSegment(t)+e.lineWidth;e.moveTo(A,i);const r=A+Math.ceil(t*t*this.width);return e.lineTo(r,i),e.stroke(),r}yOffsetSegment(e){const A=this.showNecklace?tU:yu+Yn;return(e<0?A:0)+(this.showNecklace?Yn+nU:0)}drawGauge(e,A,t,i){const r=this.height-A,s=3,o=r-2;if(o>=10){const l=Math.SQRT1_2*o,c=this.width/2-o,u=new ye(c+o,A+o),h=this.thief_a_color,p=this.thief_b_color,g=this.gauge_color;e.beginPath(),e.fillStyle=this.thief_a_color_light,e.moveTo(u.x,u.y),e.arc(u.x,u.y,o,-Math.PI,-Math.PI/2),e.lineTo(u.x,u.y),e.closePath(),e.fill(),e.beginPath(),e.fillStyle=this.thief_b_color_light,e.moveTo(u.x,u.y),e.arc(u.x,u.y,o,-Math.PI/2,0),e.lineTo(u.x,u.y),e.closePath(),e.fill(),e.beginPath(),e.lineWidth=1,e.setLineDash([1,1]),e.arc(u.x,u.y,o/2,0,-Math.PI,!0),e.stroke(),e.beginPath(),e.strokeStyle=h,e.setLineDash([]),e.moveTo(u.x,u.y),e.lineTo(u.x-t.x*l,u.y-t.y*l),e.stroke(),e.beginPath(),e.strokeStyle=p,e.moveTo(u.x,u.y),e.lineTo(u.x+i.x*l,u.y-i.y*l),e.stroke();const m=1-Math.SQRT1_2*t.distanceTo(i),d=255+(0-255)*m,f=0+(255-0)*m;e.beginPath(),e.lineWidth=s,e.strokeStyle=`rgb(${d},${f}, 0)`,e.arc(u.x,u.y,o,-Math.PI,-Math.PI*(1-m),!1),e.stroke(),e.beginPath(),e.lineWidth=s,e.strokeStyle=g,e.arc(u.x,u.y,o,-Math.PI*(1-m),0,!1),e.stroke()}}yOffset(e,A,t){if(e===void 0)return 0;const i=e.x*e.x,r=e.y*e.y;return A<i?e.x<0?t:0:A<i+r?e.y<0?t:0:e.z<0?t:0}}function Su(n){return n%1}class rU{#A;#e;#t;#n;constructor(){this.initializeStatus(0),window.addEventListener(le.SET_NECKLACE_CONFIGURATION_BY_NUMBER,()=>this.necklaceFromInt(Ae.necklace.configuration,Ae.necklace.number_of_jewels)),window.addEventListener(le.SET_NECKLACE_CONFIGURATION_BY_STRING,()=>this.necklaceFromStr(Ae.necklace.string))}get necklace(){return[...this.#A]}necklaceFromInt(e,A){this.initializeStatus(A);const t=e.toString(2);if(e!=0){const i=t.length-1;for(let r=i;r>=0;r--)this.#A[i-r]=t[r]==="0"?0:1}for(const i of this.#A)i===0?this.#e.x+=1:this.#e.y+=1;le.dispatchEvent(le.UPDATE_SPHERE_MATERIAL)}necklaceFromStr(e){this.initializeStatus(1),this.#A=[];for(let A=0;A<e.length;A++){const t=e.charCodeAt(A),i=t.toString(2);if(t!=0)for(const r of i)this.#A.push(r==="0"?0:1)}for(const A of this.#A)A===0?this.#e.x+=1:this.#e.y+=1;le.dispatchEvent(le.UPDATE_SPHERE_MATERIAL)}get size(){if(this.cnt.x<0||this.cnt.y<0)throw Error("Necklace not initialized");return this.cnt.x+this.cnt.y}applyCut(e){this.cuts=e,e!==void 0&&(this.#n=Ae.necklace.discrete?this.applyCutDiscrete(e):this.applyCutContinous(e)),le.dispatchEvent(le.NECKLACE_CUT)}applyCutDiscrete(e){if(this.cuts=e,e){const A=this.size,t=e.x*e.x*A,i=e.y*e.y*A,r=[0,0];for(let s=0;s<A;s++){const a=this.necklace[s],o=s;o<t?e.x>0&&r[a]++:o<t+i?e.y>0&&r[a]++:e.z>0&&r[a]++}return new ye(r[0],r[1])}return new ye(0,0)}applyCutContinous(e){if(this.cuts=e,e){const A=this.size,t=e.x*e.x*A,i=e.y*e.y*A,r=[0,0];for(let s=0;s<A;s++){const a=this.necklace[s],o=s+1;let l=0,c=0,u=0;o<=Math.ceil(t)?o<=Math.floor(t)?l=1:(l=Su(t),o>t+i?(c=i,u=1-l-c):c=1-l):o<=Math.ceil(t+i)?o<=Math.floor(t+i)?c=1:(c=Su(t+i),u=1-c):u=1,l!==0&&e.x>0&&(r[a]+=l),c!==0&&e.y>0&&(r[a]+=c),u!==0&&e.z>0&&(r[a]+=u)}return new ye(r[0],r[1])}return new ye(0,0)}initializeStatus(e){this.#A=Array(e).fill(0),this.#e=new ye(0,0),this.#t=new I(0,0),this.#n=new ye(0,0)}get cnt(){return this.#e.clone()}set cnt(e){this.#e=e.clone()}get count_0(){return this.#e.x}get count_1(){return this.#e.y}get cuts(){return this.#t?this.#t.clone():void 0}set cuts(e){e!==void 0&&(this.assertSphere(e),this.#t=e.clone())}assertSphere(e,A=1){if(e.length()-A>oo)throw new Error(`Input vector ${e} not close enough to sphere with radius ${A}, dist to orgin: ${e.length()}`)}get thief_a(){return this.#n!==void 0?this.#n.clone():new ye(0,0)}set thief_a(e){this.#n=e.clone()}get thief_b(){return this.#n!==void 0?this.cnt.sub(this.#n):new ye(0,0)}canonicalThief(e){const A=this.#e.x!==0?e.x/this.#e.x:0,t=this.#e.y!==0?e.y/this.#e.y:0;return new ye(A,t)}}const sU=new Vi,hf=await Fo.create(),ff=new rU,df=new Wx(ff),aU=new iU(ff);hf.initTheme();hf.registerOnThemeChange(document.body);le.dispatchEvent(le.SET_NECKLACE_CONFIGURATION_BY_NUMBER);df.render();new f0({folder:sU.captureFolder,property:Ae.capture},{all:document.body,sphere:df.captureElement,necklace:aU.captureElement});const Oo=document.createElement("SPAN");Oo.setAttribute("id","version-info");Oo.innerHTML="v0.4.9";document.body.insertAdjacentElement("beforeend",Oo);
