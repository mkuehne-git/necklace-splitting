...
</svg>`,A_={id:"close",svg:e_};var nn,Qn,rn;const Sl=class Sl{constructor(e,A){ke(this,nn,void 0);ke(this,Qn,void 0);ke(this,rn,void 0);be(this,nn,!0),be(this,Qn,A),be(this,rn,e),K(this,rn).hide(),K(this,Qn).show(K(this,nn)?0:1),K(this,Qn).addOnClickListener(()=>this.guiShowHide())}static create(e){const A=new Cf({icons:[$0,A_],classToken:"settings",event:ce.SETTINGS_CHANGED});return new Sl(e,A)}guiShowHide(){K(this,nn)?(this.toggle(),K(this,rn).show(),K(this,rn).open()):K(this,rn).$title.click()}toggle(){be(this,nn,!K(this,nn)),K(this,Qn).toggle()}};nn=new WeakMap,Qn=new WeakMap,rn=new WeakMap;let Zo=Sl;const jo=.001,t_=jo*jo,n_=32,Ks=["Stolen Necklace","Shader Lamp","Space Colors","Sinusoid"],te={showcase:Ks[St.STOLEN_NECKLACE],int_mode:St.STOLEN_NECKLACE,necklace:{number_of_jewels:24,configuration:13579652,string:"",show_solution_band:!0,show_solutions:!0,epsilon:.01,discrete:!0},sphere:{radius:15,segments:128,offset_octant:0,use_bad_on_sphere_check:!1,show_borsuk_ulam_proof_shape:!1},animation:{rotation_x:0,rotation_y:0,rotation_z:0,reset_speed:i_,trigger_reset:!1,run:!1},view:{stats_monitor_visible:!1,necklace_visible:!0,gauge_visible:!0,show_single_thiefs_region:!0,axes_visible:!0,mesh_visible:!1,faces_visible:!0},color:{scale_red:1,scale_green:1,scale_blue:1,alpha:1},capture:{},imprint:()=>ce.dispatchEvent(ce.SHOW_IMPRINT),radio:Ks[St.STOLEN_NECKLACE],text:void 0};var Ur,In,Mi,TA,js,$s;const ea=class ea{constructor(){ke(this,Ur,void 0);ke(this,In,void 0);ke(this,Mi,void 0);ke(this,TA,void 0);ke(this,js,void 0);ke(this,$s,void 0);be(this,TA,new ll),K(this,TA).domElement.id="gui",this.createSettingsIcon(),this.createShowHideListener(),this.createShowcaseFolder(),this.createNecklaceFolder(),this.createViewFolder(),this.createCaptureFolder()}static addRadioButtonsFolder(e,A,t,i,r=(s,a,o)=>{}){const s=e.addFolder(A);return ea.addRadioButtons(s,t,i,r),s}static addRadioButtons(e,A,t,i=(r,s,a)=>{}){const r=A;A={},t.forEach((s,a)=>{const o=`option_${a}`;A[o]=r===s}),t.forEach((s,a)=>{const o=`option_${a}`;e.add(A,o).name(s).listen().onChange(()=>{for(let l in A)A[l]=o===l;i(A,o,a)})})}async createSettingsIcon(){const e=await Zo.create(K(this,TA));new mh(K(this,TA).domElement,(A,t)=>{const i=A.target;t===0&&!(i!=null&&i.classList.contains("transition"))&&(i!=null&&i.classList.contains("closed"))&&(K(this,TA).hide(),K(this,TA).close(),e.toggle())})}toggleSettings(){K(this,js).classList.toggle("show"),K(this,$s).classList.toggle("show")}createShowHideListener(){window.addEventListener("keydown",e=>{(e.key==="h"||e.key==="H")&&(K(this,Mi)?K(this,TA).show():K(this,TA).hide(),be(this,Mi,!K(this,Mi)))})}createShowcaseFolder(){be(this,In,ea.addRadioButtonsFolder(K(this,TA),`Showcase: ${te.radio}`,te.radio,Ks,(e,A,t)=>{te.int_mode=t,ce.dispatchEvent(ce.CREATE_SPHERE),K(this,In).title(`Showcase: ${Ks[t]}`),K(this,In).close()})),K(this,In).close()}createNecklaceFolder(){const e=K(this,TA).addFolder("Necklace");e.add(te.necklace,"number_of_jewels",0,n_,1).name("Jewels").onChange(()=>{const t=2**te.necklace.number_of_jewels-1;te.necklace.configuration=Math.min(t,te.necklace.configuration),A.min(0).max(t).setValue(te.necklace.configuration),ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)});const A=e.add(te.necklace,"configuration",0,2**te.necklace.number_of_jewels-1,1).name("Configuration").onChange(()=>ce.dispatchEvent(ce.SET_NECKLACE_CONFIGURATION_BY_NUMBER));e.add(te.necklace,"string").name("String").onChange(()=>ce.dispatchEvent(ce.SET_NECKLACE_CONFIGURATION_BY_STRING)),e.add(te.necklace,"discrete").name("Discrete").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),e.add(te.necklace,"show_solution_band").name("Solution Band").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),e.add(te.necklace,"show_solutions").name("Solutions").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),e.add(te.necklace,"epsilon",0,.15).name("epsilon").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),e.close()}createViewFolder(){const e=K(this,TA).addFolder("View");e.add(te.view,"show_single_thiefs_region").name("Single Thief's Area").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),e.add(te.view,"axes_visible").name("Axes").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),e.add(te.view,"mesh_visible").name("Mesh").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),e.add(te.view,"faces_visible").name("Faces").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),e.close(),this.createSphereSubFolder(e),this.createControlsSubFolder(e),this.createColorSubFolder(e),this.createAnimationSubFolder(e)}createSphereSubFolder(e){const A=e.addFolder("Sphere");A.add(te.sphere,"radius",1,50,1).name("Radius").onChange(()=>ce.dispatchEvent(ce.CREATE_SPHERE)),A.add(te.sphere,"offset_octant",0,5,.1).name("Octant Offset").onChange(()=>ce.dispatchEvent(ce.CREATE_SPHERE)),A.add(te.sphere,"use_bad_on_sphere_check").name("Bad Check").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),A.add(te.sphere,"show_borsuk_ulam_proof_shape").name("Borsuk-Ulam Proof").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),A.add(te.sphere,"segments",3,511,1).name("Segments").onChange(()=>ce.dispatchEvent(ce.CREATE_SPHERE)),A.close()}createControlsSubFolder(e){const A=e.addFolder("Other Controls");A.add(te.view,"stats_monitor_visible").name("Monitor").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),A.add(te.view,"necklace_visible").name("Necklace").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),A.add(te.view,"gauge_visible").name("Gauge").onChange(()=>ce.dispatchEvent(ce.UPDATE_VISIBLE)),A.close()}createColorSubFolder(e){const A=e.addFolder("Color");A.add(te.color,"scale_red",0,1).name("Red").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),A.add(te.color,"scale_green",0,1).name("Green").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),A.add(te.color,"scale_blue",0,1).name("Blue").onChange(()=>ce.dispatchEvent(ce.UPDATE_SPHERE_MATERIAL)),A.add(te.color,"alpha",0,1).name("Alpha").onChange(()=>ce.dispatchEvent(ce.CREATE_SPHERE)),A.close()}createAnimationSubFolder(e){const A=e.addFolder("Animation"),t=.5;A.add(te.animation,"run").name("Rotate [Hz]").listen(),A.add(te.animation,"rotation_x",-t,t,.1).name("X").listen(),A.add(te.animation,"rotation_y",-t,t,.1).name("Y").listen(),A.add(te.animation,"rotation_z",-t,t,.1).name("Z").listen(),A.add(te.animation,"reset_speed").name("Reset Rotation"),A.close()}createCaptureFolder(){const e=K(this,TA).addFolder("Screen capture");new J0().isAvailable().then(i=>{i&&K(this,TA).add(te,"imprint").name("Imprint")}),e.close(),be(this,Ur,e)}get captureFolder(){return K(this,Ur)}};Ur=new WeakMap,In=new WeakMap,Mi=new WeakMap,TA=new WeakMap,js=new WeakMap,$s=new WeakMap;let ks=ea;function i_(){te.animation.trigger_reset=!0,te.animation.run=!1,te.animation.rotation_x=0,te.animation.rotation_y=0,te.animation.rotation_z=0}const r_=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="512" height="512">
...
#endif`,Sv="gl_FragColor = linearToOutputTexel( gl_FragColor );",Mv=`
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Vu(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xl(),fragmentShader:`
		...
		`,blending:fn,depthTest:!1,depthWrite:!1})}function Ku(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xl(),fragmentShader:`
	...
	`}function OC(n){let e=new WeakMap,A=null;function t(a){if(a&&a.isTexture){const o=a.mapping,l=o===Al||o===tl,c=o===Hi||o===Pi;if(l||c)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let u=e.get(a);return A===null&&(A=new Nu(n)),u=l?A.fromEquirectangular(a,u):A.fromCubemap(a,u),e.set(a,u),u.texture}else{if(e.has(a))return e.get(a).texture;{const u=a.image;if(l&&u&&u.height>0||c&&u&&i(u)){A===null&&(A=new Nu(n));const h=l?A.fromEquirectangular(a):A.fromCubemap(a);return e.set(a,h),a.addEventListener("dispose",r),h.texture}else return null}}}return a}function i(a){let o=0;const l=6;for(let c=0;c<l;c++)a[c]!==void 0&&o++;return o===l}function r(a){const o=a.target;o.removeEventListener("dispose",r);const l=e.get(o);l!==void 0&&(e.delete(o),l.dispose())}function s(){e=new WeakMap,A!==null&&(A.dispose(),A=null)}return{get:t,dispose:s}}function NC(n){const e={};function A(t){if(e[t]!==void 0)return e[t];let i;switch(t){case"WEBGL_depth_texture":i=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=n.getExtension(t)}return e[t]=i,i}return{has:function(t){return A(t)!==null},init:function(t){t.isWebGL2?A("EXT_color_buffer_float"):(A("WEBGL_depth_texture"),A("OES_texture_float"),A("OES_texture_half_float"),A("OES_texture_half_float_linear"),A("OES_standard_derivatives"),A("OES_element_index_uint"),A("OES_vertex_array_object"),A("ANGLE_instanced_arrays")),A("OES_texture_float_linear"),A("EXT_color_buffer_half_float"),A("WEBGL_multisampled_render_to_texture")},get:function(t){const i=A(t);return i===null&&console.warn("THREE.WebGLRenderer: "+t+" extension not supported."),i}}}function GC(n,e,A,t){const i={},r=new WeakMap;function s(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const m=h.morphAttributes[g];for(let d=0,f=m.length;d<f;d++)e.remove(m[d])}h.removeEventListener("dispose",s),delete i[h.id];const p=r.get(h);p&&(e.remove(p),r.delete(h)),t.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,A.memory.geometries--}function a(u,h){return i[h.id]===!0||(h.addEventListener("dispose",s),i[h.id]=!0,A.memory.geometries++),h}function o(u){const h=u.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const m=p[g];for(let d=0,f=m.length;d<f;d++)e.update(m[d],n.ARRAY_BUFFER)}}function l(u){const h=[],p=u.index,g=u.attributes.position;let m=0;if(p!==null){const v=p.array;m=p.version;for(let w=0,C=v.length;w<C;w+=3){const x=v[w+0],U=v[w+1],y=v[w+2];h.push(x,U,U,y,y,x)}}else if(g!==void 0){const v=g.array;m=g.version;for(let w=0,C=v.length/3-1;w<C;w+=3){const x=w+0,U=w+1,y=w+2;h.push(x,U,U,y,y,x)}}else return;const d=new(Rf(h)?Gf:Nf)(h,1);d.version=m;const f=r.get(u);f&&e.remove(f),r.set(u,d)}function c(u){const h=r.get(u);if(h){const p=u.index;p!==null&&h.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:o,getWireframeAttribute:c}}function VC(n,e,A,t){const i=t.isWebGL2;let r;function s(h){r=h}let a,o;function l(h){a=h.type,o=h.bytesPerElement}function c(h,p){n.drawElements(r,p,a,h*o),A.update(p,r,1)}function u(h,p,g){if(g===0)return;let m,d;if(i)m=n,d="drawElementsInstanced";else if(m=e.get("ANGLE_instanced_arrays"),d="drawElementsInstancedANGLE",m===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}m[d](r,p,a,h*o,g),A.update(p,r,g)}this.setMode=s,this.setIndex=l,this.render=c,this.renderInstances=u}function KC(n){const e={geometries:0,textures:0},A={frame:0,calls:0,triangles:0,points:0,lines:0};function t(r,s,a){switch(A.calls++,s){case n.TRIANGLES:A.triangles+=a*(r/3);break;case n.LINES:A.lines+=a*(r/2);break;case n.LINE_STRIP:A.lines+=a*(r-1);break;case n.LINE_LOOP:A.lines+=a*r;break;case n.POINTS:A.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function i(){A.calls=0,A.triangles=0,A.points=0,A.lines=0}return{memory:e,render:A,programs:null,autoReset:!0,reset:i,update:t}}function kC(n,e){return n[0]-e[0]}function zC(n,e){return Math.abs(e[1])-Math.abs(n[1])}function WC(n,e,A){const t={},i=new Float32Array(8),r=new WeakMap,s=new SA,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function o(l,c,u){const h=l.morphTargetInfluences;if(e.isWebGL2===!0){const g=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,m=g!==void 0?g.length:0;let d=r.get(c);if(d===void 0||d.count!==m){let N=function(){Y.dispose(),r.delete(c),c.removeEventListener("dispose",N)};var p=N;d!==void 0&&d.texture.dispose();const w=c.morphAttributes.position!==void 0,C=c.morphAttributes.normal!==void 0,x=c.morphAttributes.color!==void 0,U=c.morphAttributes.position||[],y=c.morphAttributes.normal||[],R=c.morphAttributes.color||[];let B=0;w===!0&&(B=1),C===!0&&(B=2),x===!0&&(B=3);let M=c.attributes.position.count*B,z=1;M>e.maxTextureSize&&(z=Math.ceil(M/e.maxTextureSize),M=e.maxTextureSize);const J=new Float32Array(M*z*4*m),Y=new Pf(J,M,z,m);Y.type=cn,Y.needsUpdate=!0;const T=B*4;for(let X=0;X<m;X++){const k=U[X],ee=y[X],Z=R[X],q=M*z*4*X;for(let Q=0;Q<k.count;Q++){const O=Q*T;w===!0&&(s.fromBufferAttribute(k,Q),J[q+O+0]=s.x,J[q+O+1]=s.y,J[q+O+2]=s.z,J[q+O+3]=0),C===!0&&(s.fromBufferAttribute(ee,Q),J[q+O+4]=s.x,J[q+O+5]=s.y,J[q+O+6]=s.z,J[q+O+7]=0),x===!0&&(s.fromBufferAttribute(Z,Q),J[q+O+8]=s.x,J[q+O+9]=s.y,J[q+O+10]=s.z,J[q+O+11]=Z.itemSize===4?s.w:1)}}d={count:m,texture:Y,size:new Se(M,z)},r.set(c,d),c.addEventListener("dispose",N)}let f=0;for(let w=0;w<h.length;w++)f+=h[w];const v=c.morphTargetsRelative?1:1-f;u.getUniforms().setValue(n,"morphTargetBaseInfluence",v),u.getUniforms().setValue(n,"morphTargetInfluences",h),u.getUniforms().setValue(n,"morphTargetsTexture",d.texture,A),u.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}else{const g=h===void 0?0:h.length;let m=t[c.id];if(m===void 0||m.length!==g){m=[];for(let C=0;C<g;C++)m[C]=[C,0];t[c.id]=m}for(let C=0;C<g;C++){const x=m[C];x[0]=C,x[1]=h[C]}m.sort(zC);for(let C=0;C<8;C++)C<g&&m[C][1]?(a[C][0]=m[C][0],a[C][1]=m[C][1]):(a[C][0]=Number.MAX_SAFE_INTEGER,a[C][1]=0);a.sort(kC);const d=c.morphAttributes.position,f=c.morphAttributes.normal;let v=0;for(let C=0;C<8;C++){const x=a[C],U=x[0],y=x[1];U!==Number.MAX_SAFE_INTEGER&&y?(d&&c.getAttribute("morphTarget"+C)!==d[U]&&c.setAttribute("morphTarget"+C,d[U]),f&&c.getAttribute("morphNormal"+C)!==f[U]&&c.setAttribute("morphNormal"+C,f[U]),i[C]=y,v+=y):(d&&c.hasAttribute("morphTarget"+C)===!0&&c.deleteAttribute("morphTarget"+C),f&&c.hasAttribute("morphNormal"+C)===!0&&c.deleteAttribute("morphNormal"+C),i[C]=0)}const w=c.morphTargetsRelative?1:1-v;u.getUniforms().setValue(n,"morphTargetBaseInfluence",w),u.getUniforms().setValue(n,"morphTargetInfluences",i)}}return{update:o}}function XC(n,e,A,t){let i=new WeakMap;function r(o){const l=t.render.frame,c=o.geometry,u=e.get(o,c);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),o.isInstancedMesh&&(o.hasEventListener("dispose",a)===!1&&o.addEventListener("dispose",a),i.get(o)!==l&&(A.update(o.instanceMatrix,n.ARRAY_BUFFER),o.instanceColor!==null&&A.update(o.instanceColor,n.ARRAY_BUFFER),i.set(o,l))),o.isSkinnedMesh){const h=o.skeleton;i.get(h)!==l&&(h.update(),i.set(h,l))}return u}function s(){i=new WeakMap}function a(o){const l=o.target;l.removeEventListener("dispose",a),A.remove(l.instanceMatrix),l.instanceColor!==null&&A.remove(l.instanceColor)}return{update:r,dispose:s}}const Xf=new jA,Yf=new Pf,Jf=new Qw,qf=new kf,ku=[],zu=[],Wu=new Float32Array(16),Xu=new Float32Array(9),Yu=new Float32Array(4);function Ki(n,e,A){const t=n[0];if(t<=0||t>0)return n;const i=e*A;let r=ku[i];if(r===void 0&&(r=new Float32Array(i),ku[i]=r),e!==0){t.toArray(r,0);for(let s=1,a=0;s!==e;++s)a+=A,n[s].toArray(r,a)}return r}function mA(n,e){if(n.length!==e.length)return!1;for(let A=0,t=n.length;A<t;A++)if(n[A]!==e[A])return!1;return!0}function BA(n,e){for(let A=0,t=e.length;A<t;A++)n[A]=e[A]}function Ba(n,e){let A=zu[e];A===void 0&&(A=new Int32Array(e),zu[e]=A);for(let t=0;t!==e;++t)A[t]=n.allocateTextureUnit();return A}function YC(n,e){const A=this.cache;A[0]!==e&&(n.uniform1f(this.addr,e),A[0]=e)}function JC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(mA(A,e))return;n.uniform2fv(this.addr,e),BA(A,e)}}function qC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else if(e.r!==void 0)(A[0]!==e.r||A[1]!==e.g||A[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),A[0]=e.r,A[1]=e.g,A[2]=e.b);else{if(mA(A,e))return;n.uniform3fv(this.addr,e),BA(A,e)}}function ZC(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(mA(A,e))return;n.uniform4fv(this.addr,e),BA(A,e)}}function jC(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(mA(A,e))return;n.uniformMatrix2fv(this.addr,!1,e),BA(A,e)}else{if(mA(A,t))return;Yu.set(t),n.uniformMatrix2fv(this.addr,!1,Yu),BA(A,t)}}function $C(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(mA(A,e))return;n.uniformMatrix3fv(this.addr,!1,e),BA(A,e)}else{if(mA(A,t))return;Xu.set(t),n.uniformMatrix3fv(this.addr,!1,Xu),BA(A,t)}}function ex(n,e){const A=this.cache,t=e.elements;if(t===void 0){if(mA(A,e))return;n.uniformMatrix4fv(this.addr,!1,e),BA(A,e)}else{if(mA(A,t))return;Wu.set(t),n.uniformMatrix4fv(this.addr,!1,Wu),BA(A,t)}}function Ax(n,e){const A=this.cache;A[0]!==e&&(n.uniform1i(this.addr,e),A[0]=e)}function tx(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(mA(A,e))return;n.uniform2iv(this.addr,e),BA(A,e)}}function nx(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else{if(mA(A,e))return;n.uniform3iv(this.addr,e),BA(A,e)}}function ix(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(mA(A,e))return;n.uniform4iv(this.addr,e),BA(A,e)}}function rx(n,e){const A=this.cache;A[0]!==e&&(n.uniform1ui(this.addr,e),A[0]=e)}function sx(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),A[0]=e.x,A[1]=e.y);else{if(mA(A,e))return;n.uniform2uiv(this.addr,e),BA(A,e)}}function ax(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),A[0]=e.x,A[1]=e.y,A[2]=e.z);else{if(mA(A,e))return;n.uniform3uiv(this.addr,e),BA(A,e)}}function ox(n,e){const A=this.cache;if(e.x!==void 0)(A[0]!==e.x||A[1]!==e.y||A[2]!==e.z||A[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),A[0]=e.x,A[1]=e.y,A[2]=e.z,A[3]=e.w);else{if(mA(A,e))return;n.uniform4uiv(this.addr,e),BA(A,e)}}function lx(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture2D(e||Xf,i)}function cx(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture3D(e||Jf,i)}function ux(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTextureCube(e||qf,i)}function hx(n,e,A){const t=this.cache,i=A.allocateTextureUnit();t[0]!==i&&(n.uniform1i(this.addr,i),t[0]=i),A.setTexture2DArray(e||Yf,i)}function fx(n){switch(n){case 5126:return YC;case 35664:return JC;case 35665:return qC;case 35666:return ZC;case 35674:return jC;case 35675:return $C;case 35676:return ex;case 5124:case 35670:return Ax;case 35667:case 35671:return tx;case 35668:case 35672:return nx;case 35669:case 35673:return ix;case 5125:return rx;case 36294:return sx;case 36295:return ax;case 36296:return ox;case 35678:case 36198:case 36298:case 36306:case 35682:return lx;case 35679:case 36299:case 36307:return cx;case 35680:case 36300:case 36308:case 36293:return ux;case 36289:case 36303:case 36311:case 36292:return hx}}function dx(n,e){n.uniform1fv(this.addr,e)}function px(n,e){const A=Ki(e,this.size,2);n.uniform2fv(this.addr,A)}function gx(n,e){const A=Ki(e,this.size,3);n.uniform3fv(this.addr,A)}function mx(n,e){const A=Ki(e,this.size,4);n.uniform4fv(this.addr,A)}function Bx(n,e){const A=Ki(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,A)}function _x(n,e){const A=Ki(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,A)}function wx(n,e){const A=Ki(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,A)}function vx(n,e){n.uniform1iv(this.addr,e)}function Ex(n,e){n.uniform2iv(this.addr,e)}function Cx(n,e){n.uniform3iv(this.addr,e)}function xx(n,e){n.uniform4iv(this.addr,e)}function Ux(n,e){n.uniform1uiv(this.addr,e)}function yx(n,e){n.uniform2uiv(this.addr,e)}function Sx(n,e){n.uniform3uiv(this.addr,e)}function Mx(n,e){n.uniform4uiv(this.addr,e)}function Fx(n,e,A){const t=this.cache,i=e.length,r=Ba(A,i);mA(t,r)||(n.uniform1iv(this.addr,r),BA(t,r));for(let s=0;s!==i;++s)A.setTexture2D(e[s]||Xf,r[s])}function bx(n,e,A){const t=this.cache,i=e.length,r=Ba(A,i);mA(t,r)||(n.uniform1iv(this.addr,r),BA(t,r));for(let s=0;s!==i;++s)A.setTexture3D(e[s]||Jf,r[s])}function Tx(n,e,A){const t=this.cache,i=e.length,r=Ba(A,i);mA(t,r)||(n.uniform1iv(this.addr,r),BA(t,r));for(let s=0;s!==i;++s)A.setTextureCube(e[s]||qf,r[s])}function Qx(n,e,A){const t=this.cache,i=e.length,r=Ba(A,i);mA(t,r)||(n.uniform1iv(this.addr,r),BA(t,r));for(let s=0;s!==i;++s)A.setTexture2DArray(e[s]||Yf,r[s])}function Ix(n){switch(n){case 5126:return dx;case 35664:return px;case 35665:return gx;case 35666:return mx;case 35674:return Bx;case 35675:return _x;case 35676:return wx;case 5124:case 35670:return vx;case 35667:case 35671:return Ex;case 35668:case 35672:return Cx;case 35669:case 35673:return xx;case 5125:return Ux;case 36294:return yx;case 36295:return Sx;case 36296:return Mx;case 35678:case 36198:case 36298:case 36306:case 35682:return Fx;case 35679:case 36299:case 36307:return bx;case 35680:case 36300:case 36308:case 36293:return Tx;case 36289:case 36303:case 36311:case 36292:return Qx}}class Lx{constructor(e,A,t){this.id=e,this.addr=t,this.cache=[],this.setValue=fx(A.type)}}class Rx{constructor(e,A,t){this.id=e,this.addr=t,this.cache=[],this.size=A.size,this.setValue=Ix(A.type)}}class Dx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,A,t){const i=this.seq;for(let r=0,s=i.length;r!==s;++r){const a=i[r];a.setValue(e,A[a.id],t)}}}const Eo=/(\w+)(\])?(\[|\.)?/g;function Ju(n,e){n.seq.push(e),n.map[e.id]=e}function Hx(n,e,A){const t=n.name,i=t.length;for(Eo.lastIndex=0;;){const r=Eo.exec(t),s=Eo.lastIndex;let a=r[1];const o=r[2]==="]",l=r[3];if(o&&(a=a|0),l===void 0||l==="["&&s+2===i){Ju(A,l===void 0?new Lx(a,n,e):new Rx(a,n,e));break}else{let u=A.map[a];u===void 0&&(u=new Dx(a),Ju(A,u)),A=u}}}class Qs{constructor(e,A){this.seq=[],this.map={};const t=e.getProgramParameter(A,e.ACTIVE_UNIFORMS);for(let i=0;i<t;++i){const r=e.getActiveUniform(A,i),s=e.getUniformLocation(A,r.name);Hx(r,s,this)}}setValue(e,A,t,i){const r=this.map[A];r!==void 0&&r.setValue(e,t,i)}setOptional(e,A,t){const i=A[t];i!==void 0&&this.setValue(e,t,i)}static upload(e,A,t,i){for(let r=0,s=A.length;r!==s;++r){const a=A[r],o=t[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,i)}}static seqWithValue(e,A){const t=[];for(let i=0,r=e.length;i!==r;++i){const s=e[i];s.id in A&&t.push(s)}return t}}function qu(n,e,A){const t=n.createShader(e);return n.shaderSource(t,A),n.compileShader(t),t}const Px=37297;let Ox=0;function Nx(n,e){const A=n.split(`
`),t=[],i=Math.max(e-6,0),r=Math.min(e+6,A.length);for(let s=i;s<r;s++){const a=s+1;t.push(`${a===e?">":" "} ${a}: ${A[s]}`)}return t.join(`
`)}function Gx(n){const e=$e.getPrimaries($e.workingColorSpace),A=$e.getPrimaries(n);let t;switch(e===A?t="":e===Ys&&A===Xs?t="LinearDisplayP3ToLinearSRGB":e===Xs&&A===Ys&&(t="LinearSRGBToLinearDisplayP3"),n){case Xt:case da:return[t,"LinearTransferOETF"];case UA:case _l:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[t,"LinearTransferOETF"]}}function Zu(n,e,A){const t=n.getShaderParameter(e,n.COMPILE_STATUS),i=n.getShaderInfoLog(e).trim();if(t&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const s=parseInt(r[1]);return A.toUpperCase()+`

`+i+`

`+Nx(n.getShaderSource(e),s)}else return i}function Vx(n,e){const A=Gx(e);return`vec4 ${n}( vec4 value ) { return ${A[0]}( ${A[1]}( value ) ); }`}function Kx(n,e){let A;switch(e){case O_:A="Linear";break;case N_:A="Reinhard";break;case G_:A="OptimizedCineon";break;case V_:A="ACESFilmic";break;case K_:A="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),A="Linear"}return"vec3 "+n+"( vec3 color ) { return "+A+"ToneMapping( color ); }"}function kx(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(sr).join(`
`)}function zx(n){const e=[];for(const A in n){const t=n[A];t!==!1&&e.push("#define "+A+" "+t)}return e.join(`
`)}function Wx(n,e){const A={},t=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let i=0;i<t;i++){const r=n.getActiveAttrib(e,i),s=r.name;let a=1;r.type===n.FLOAT_MAT2&&(a=2),r.type===n.FLOAT_MAT3&&(a=3),r.type===n.FLOAT_MAT4&&(a=4),A[s]={type:r.type,location:n.getAttribLocation(e,s),locationSize:a}}return A}function sr(n){return n!==""}function ju(n,e){const A=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,A).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function $u(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Xx=/^[ \t]*#include +<([\w\d./]+)>/gm;function al(n){return n.replace(Xx,Jx)}const Yx=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Jx(n,e){let A=Ve[e];if(A===void 0){const t=Yx.get(e);if(t!==void 0)A=Ve[t],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,t);else throw new Error("Can not resolve #include <"+e+">")}return al(A)}const qx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function eh(n){return n.replace(qx,Zx)}function Zx(n,e,A,t){let i="";for(let r=parseInt(e);r<parseInt(A);r++)i+=t.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function Ah(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function jx(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Uf?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===f_?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Vt&&(e="SHADOWMAP_TYPE_VSM"),e}function $x(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Hi:case Pi:e="ENVMAP_TYPE_CUBE";break;case fa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function eU(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Pi:e="ENVMAP_MODE_REFRACTION";break}return e}function AU(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case yf:e="ENVMAP_BLENDING_MULTIPLY";break;case H_:e="ENVMAP_BLENDING_MIX";break;case P_:e="ENVMAP_BLENDING_ADD";break}return e}function tU(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const A=Math.log2(e)-2,t=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,A),7*16)),texelHeight:t,maxMip:A}}function nU(n,e,A,t){const i=n.getContext(),r=A.defines;let s=A.vertexShader,a=A.fragmentShader;const o=jx(A),l=$x(A),c=eU(A),u=AU(A),h=tU(A),p=A.isWebGL2?"":kx(A),g=zx(r),m=i.createProgram();let d,f,v=A.glslVersion?"#version "+A.glslVersion+`
...
}`,VU=`#define M_PI 3.1415926535897932384626433832795
uniform int u_mode;
uniform bool u_necklace_absolute;
uniform bool u_necklace_discrete;
uniform bool u_show_solution_band;
